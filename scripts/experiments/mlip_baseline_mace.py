#!/usr/bin/env python3
"""
MACE baseline performance on 25Cao dataset
Conda env: mace
"""
...
class MACEPredictor:
    ...
    def load_model(self):
        ...
        model_path = MODEL_DIR / "mace-mh-0.model"
        ...
        print(f"Loaded MACE model: {model_path.name} on {device}")
...
def main():
    ...
    parser.add_argument('--models', nargs='+', default=['mace-mh-0'])
    ...
    for model_name in args.models:
        ...
        predictor = MACEPredictor(model_name)
    ...
    excel_path = OUTPUT_DIR / 'baseline_mace.xlsx'
