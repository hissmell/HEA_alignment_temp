#!/usr/bin/env python3
"""
Equiformer (eqV2) baseline performance on 25Cao dataset
Conda env: fairchem1
"""
...
# ── Equiformer Predictor ──────────────────────────────────────────────────────

class EquiformerPredictor:
    ...
    def load_model(self):
        ...
        print(f"Loaded Equiformer model: {self.model_name} on {device}")
...
def main():
    ...
    parser.add_argument('--models', nargs='+', default=EQV2_MODELS)
    ...
    for model_name in args.models:
        ...
        predictor = EquiformerPredictor(model_name)
    ...
    excel_path = OUTPUT_DIR / 'baseline_equiformer.xlsx'
